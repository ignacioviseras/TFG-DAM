...
public class CustomerController {
	...
	@GetMapping(path="/accesses/{access_id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<Access> getAccesses(@PathVariable("access_id") int access_id){
		...
		if(c == null){
			...
			Access access =  accessDao.findByCustomerIdAndEventId(c.getId(), access_id);
			if(access == null){
	...
	public ResponseEntity<Customer> addVideoGame(@RequestBody Customer newinfo) {		
